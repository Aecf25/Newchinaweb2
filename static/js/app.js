...
const listadeCombos2 = document.getElementById('containermenu2');

combos2.forEach((product) => {
    let content = document.createElement("div");
    content.className = "card1"
    content.innerHTML = `
        <img src="${product.img}">
...
const listadeentremeses2 = document.querySelector('#containermenu4entremes');

entremeses2.forEach((product) => {
    let content = document.createElement("div");
    content.className = "card1"
    content.innerHTML = `
        <img src="${product.img}">
        ...
        <p class="precioproducto">Ref. ${product.precio}</p>
    `;
    listadeentremeses2.append(content);
